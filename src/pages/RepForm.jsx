    ...
    <div className="min-h-screen bg-gray-100 text-gray-800">
      ...
      <div className={`${isDark ? "bg-gray-800" : "bg-white"} shadow-md p-4`}>
        <div className="container mx-auto">
          <h1 className="text-2xl font-bold">Gestion des demandes d'aide</h1>
          <p className={`text-sm ${isDark ? "text-gray-400" : "text-gray-500"}`}>
            Répondez aux questions et problèmes des utilisateurs
          </p>
        </div>
      </div>
            ...
            <div className={`${isDark ? "bg-gray-800" : "bg-white"} rounded-lg shadow-md overflow-hidden`}>
              {filteredMessages.length === 0 ? (
                <div className="p-6 text-center">
                  <p className="text-gray-500 dark:text-gray-400">Aucun message trouvé</p>
                </div>
              ) : (
                        ...
                        <div className="flex items-center">
                          ...
                          <div>
                            ...
                            <div className="flex items-center text-xs text-gray-500 dark:text-gray-400">
                              ...
                              <span>{message.role === "10" ? "Patient" : "Professionnel"}</span>
                            </div>
                          </div>
                        </div>
              ...
              >
                <div className="text-center">
                  ...
                  <p className="text-gray-500 dark:text-gray-400">
                    Sélectionnez un message dans la liste pour afficher son contenu et y répondre.
                  </p>
                </div>
              </div>
            )}
