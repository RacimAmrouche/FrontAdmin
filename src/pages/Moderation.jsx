  ...
  const filteredUsers =
    activeTab === "patients"
      ...
      : professionals.filter((pro) => {
          ...
          return (
            fullName.includes(searchTerm.toLowerCase()) || pro.email.toLowerCase().includes(searchTerm.toLowerCase())
          )
        })
    ...
    <div className="min-h-screen p-4 bg-gray-100">
      ...
      <div className="container mx-auto p-4">
       ...
       { /* Liste des utilisateurs */}
              ...
              {searchTerm
                ? `No ${activeTab === "patients" ? "patient" : "professional"} found`
                : `No ${activeTab === "patients" ? "patient" : "professional"} available`}
                </p>
                </div>
              ) : (
              ...
              <div className="flex items-center mb-4">
                ...
                <div className="ml-4">
                  ...
                  <p className={`${isDark ? "text-gray-400" : "text-gray-500"}`}>
                    {activeTab === "patients" ? "Patient" : "Professionnel"}
                  </p>
                </div>
              </div>
                ...
                {selectedUser.adresse && (
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-sm">{selectedUser.adresse}</p>
                      {selectedUser.postalCode && <p className="text-sm">Code postal&nbsp;: {selectedUser.postalCode}</p>}
                    </div>
                  </div>
                )}
                ...
                {selectedUser.dateofBirth && (
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-sm">{formatDate(selectedUser.dateofBirth)}</p>
